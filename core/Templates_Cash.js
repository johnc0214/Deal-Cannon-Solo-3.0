/**************************************
 * Deal Cannon Core — Templates_Cash.gs
 * Hardcoded Cash LOI template.
 **************************************/

function getCashLoiTemplate_() {
  return [
    ...
    '<p>Offer Price: {{purchasePrice}}</p>',
    '<p>Type of Financing: {{financeType}}</p>',
    '<p>Earnest Money Deposit: {{earnestMoney}}</p>',
    ...
    '<p>',
      ...
      'of the basic conditions to be incorporated into a binding Purchasing Agreement. This Letter does not require either party to negotiate ',
      'in good faith or to proceed to the completion of a binding Purchase Agreement. The parties shall not be contractually bound unless and ',
      'until they enter a formal, written Purchase Agreement, which must be in form and content satisfactory to each party and to each party&apos;s ',
      'legal counsel, in their sole discretion. Neither party may rely on this Letter as creating any legal obligation of any kind.',
    '</p>',
